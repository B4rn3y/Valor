...
class valor_RscControlsGroup {
	...
	class VScrollBar : valor_RscScrollBar
	{
		width = 0.021;
		autoScrollEnabled = 1;
	};

	class HScrollBar : valor_RscScrollBar
	{
		height = 0.028;
	};
...
class valor_RscControlsGroupNoScrollbars : valor_RscControlsGroup {
...
class valor_RscListNBox
{
	...
	idcLeft = -1;
	idcRight = -1;
	class ListScrollBar: valor_RscScrollBar{};
	class ScrollBar: valor_RscScrollBar{};
};
...
class valor_RscLine : valor_RscText {
	idc = -1;
	style = 176;
	x = 0.17;
	y = 0.48;
...
class valor_RscTitle : valor_RscText {
	style = 0;
	sizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	colorText[] = {0.95, 0.95, 0.95, 1};
};

class valor_RscPicture {
	shadow = 0;
	type = 0;
	style = 48;
	sizeEx = 0.023;
...
class valor_RscTextMulti : valor_RscText
{
	linespacing = 1;
	style = 0 + 16 + 0x200;
};

class valor_RscPictureKeepAspect : valor_RscPicture
{
	style = 0x30 + 0x800;
};

class valor_RscStructuredText {
	type = 13;
	style = 0;
	x = 0;
	y = 0;
...
class valor_RscButtonTextOnly : valor_RscButton {
	SizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
	colorBackground[] = {1, 1, 1, 0};
...
class valor_RscButtonMenu : valor_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class valor_RscShortcutButtonMain : valor_RscShortcutButton {
	idc = -1;
	style = 0;
	default = 0;
	w = 0.313726;
...
class valor_RscSlider {
	h = 0.025;
	color[] = {1, 1, 1, 0.8};
	colorActive[] = {1, 1, 1, 1};
};

class valor_RscXSliderH
{
	style = 1024;
	type = 43;
	shadow = 2;
...
class valor_RscBackground : valor_RscText {
	type = 0;
	IDC = -1;
	style = 512;
	shadow = 0;
...
class valor_RscCombo {
	...
	class ComboScrollBar : valor_RscScrollBar {};
};

class valor_RscToolbox {
	colorText[] = {0.95, 0.95, 0.95, 1};
	color[] = {0.95, 0.95, 0.95, 1};
