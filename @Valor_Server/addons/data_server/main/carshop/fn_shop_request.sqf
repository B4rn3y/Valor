...
_query = format["Select classname, price from vehicle_prices where seller = '%1';",_seller];
...
[_classnames_and_prices,_id_classnames] remoteexec["valor_fnc_fillshop",_requester];
