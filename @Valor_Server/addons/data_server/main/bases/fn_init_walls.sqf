...
private ["_query","_res","_classname","_pos","_dir","_vector","_grouP_id","_object"];

_query = format["Select id, classname, pos, dir, vector, group_id from base_objects where wall = '1'"];
...

{
	...
	_grouP_id = _x select 5;
		...
		_object setvariable["valor_wall_ids",[_id,_grouP_id],true];
