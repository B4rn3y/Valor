...
_databaseName = "valor_test_server";
...
if!(HC_AVAILABLE) then {
    ...
    ["Update persistent_vehicles set locked = '0', owners = '[]'  where time_locked <= (Select DATE_ADD(CURRENT_TIMESTAMP , INTERVAL -7 HOUR)) and locked = '1' and cop = '0';",1] call valor_fnc_db_sync;
