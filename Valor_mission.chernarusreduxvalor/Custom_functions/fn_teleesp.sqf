			...
			[] spawn
				{
					...
					{
						if(isNil "valor_ESPTOOL") then
						{
						valor_ESPTOOL = ["valor_ESPTOOL","onEachFrame","playerESP"] call BIS_fnc_addStackedEventHandler;
						};
					 sleep 1;
					};
				// Delete ESP Markers
				["valor_ESPTOOL", "onEachFrame"] call BIS_fnc_removeStackedEventHandler;
				valor_ESPTOOL = nil;
				true
				};
		};
