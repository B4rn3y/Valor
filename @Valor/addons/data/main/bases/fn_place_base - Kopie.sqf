private ["_config_id","_replace","_exit","_objects_h","_counter","_conf","_objects_blueprint","_base_conf_min","_base_conf_max","_objects_hidden","_bp","_data","_classname","_pos_dependent","_dir_dependent","_vector_dependent","_object","_player_pos","_spawnpos","_place_id","_cancel_id","_confirm_id","_replace_id","_arr_with_object_data","_data_set"];
