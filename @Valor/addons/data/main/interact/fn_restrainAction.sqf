...
private["_unit"];
_unit = cursorObject;
if(player getVariable ["restrained",false]) exitWith{systemChat "You cant do anything while being restrained"};
...
if((_unit getVariable["restrained",false])) exitWith {hint "3"};
