...
_base = switch (_id) do
{
	case 0:
	{
		[
			...
			["B_CargoNet_01_ammo_F",[0.453613,6.39087,-0.00143909],-179.26,[5.78428e-007,4.91311e-007,1]],
			[
				["valor_Land_DuctTape_F",10],
				["valor_Land_Cliff_stone_medium_F",10],
				["valor_Land_Saw_F",10],
				["valor_Land_WoodenLog_F",10]
			]
		]
	};
